...
- `.slim/clonedeps/repos/HaoboGu__rmk/` - `HaoboGu/rmk` at `feat/rynk` (`3f9f1f5b`); rynk protocol source (full-duplex header+payload protocol, RynkHidService, WASM/TS type generation, command handlers) to help rmk-gui adapt the new communication protocol.
