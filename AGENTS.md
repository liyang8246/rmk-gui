...
- `.slim/clonedeps/repos/HaoboGu__rmk/` - `HaoboGu/rmk` at `feat/rynk` (`a1b4eaeb`); rynk protocol source (full-duplex header+payload protocol, RynkHidService, WASM/TS type generation, command handlers) to help rmk-gui adapt the new communication protocol.
