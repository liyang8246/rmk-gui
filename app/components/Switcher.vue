...
<template>
  <div class="text-md rounded-prime-md flex items-center gap-1 shadow-sm shadow-surface-400 dark:shadow-surface-950 px-3 py-1 bg-surface-300 dark:bg-surface-600">
