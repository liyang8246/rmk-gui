...
<template>
  ...
  >
    ...
    <p> Or use client version download from <a href="https://github.com/liyang8246/rmk-gui/releases" target="_blank" class="underline">Github Release</a>. </p>
  </Dialog>
</template>
