...
<template>
  <div class="flex flex-col justify-around items-center flex-auto gap-3 w-full h-full text-surface-500 dark:text-surface-400"
  ...
  >
    ...
    <div class="flex justify-start items-start h-10 w-full gap-3">
