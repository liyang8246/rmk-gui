...
<template>
  ...
  >
    ...
    <div class="rounded-prime-md p-3 h-full w-full overflow-hidden bg-surface-0 dark:bg-surface-950 transition-all duration-200" @click="pageMacrosStore.clearSelectedProps()">
